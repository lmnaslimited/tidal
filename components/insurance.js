            ...
            <div className=" p-4 bg-sky-50">
                <div className="border border-gray-200  rounded-lg  bg-white ">
                    <div className="container px-5 py-16 mx-auto">
                        ...
                        <a href="/scope-of-supply"> <button className="flex-shrink-0 ml-4 text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg mt-10 sm:mt-0">Know More</button></a>
                        </div>
