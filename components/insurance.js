                ...
                <div className="border border-gray-200  rounded-lg  bg-white ">
                    <div className="container px-5 py-16 mx-auto">
                        ...
                        <div className="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
                            <Pattern text="" />
                            <div className="flex-shrink-0 w-24 h-24 text-indigo-600 rounded-full inline-flex items-center justify-center mr-8">

                                <Image alt=""
                                    src= {process.env.assetPrefix + "/encrypted.png"}
                                    width='100'
                                    height='100'
                                />
                            </div>
