    ...
    <div className="p-3 flex flex-col justify-start">
      ...
      <div className="my-2 px-2">
       <div className="flex flex-row">
        ...
        <Scope_image width="52" height="28"  className="h-8" part="/brand/mak.png" alt="" />
          </div>
      </div>
       {/**  <div className="flex flex-row">
       ...
       <div className="flex flex-row">
        ...
        />
        <div className="flex flex-row grid mt-2 mx-4 gap-2 grid-cols-5 lg:grid-cols-5">
         <Scope_image width="52" height="28"  className="h-8" part="/brand/yanmar.png" alt="" />
        <Scope_image width="52" height="28"  className="h-8" part="/brand/kobediesel.png" alt="" />
       </div>
      </div>
        <div className="flex flex-row">
        <Scope_image width="32" height="32" 
        ...
        />
        <div className="flex flex-row grid mt-2 mx-4 gap-2 grid-cols-5 lg:grid-cols-5">
        <Scope_image width="52" height="28"  className="h-8" part="/brand/doosan.png" alt="" />
        <Scope_image width="52" height="28"  className="h-8" part="/brand/ssangyong.png" alt="" />
        </div>
      </div>
      </div>
