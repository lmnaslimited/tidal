...
export default function heroCta(){
    return (
        ...
        <div className="container  px-48 md:flex-row flex-col items-center ">
          <div className="lg:flex-grow md:w-1/3 -ml-48  lg:pr-30 lg:py-24 md:pr-10 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center bg-white">
