      ...
      <div className="container  md:flex-row flex-col items-center ">
        <div className="lg:flex-grow md:w-1/3 lg:pr-30  lg:py-24 md:pr-10 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center bg-white">
          ...
          <div className="ml-10">
           ...
           <a href="mailto:sales@tidalgroups.com" >  <button className="inline-flex ml-16 md:ml-0 mb-4 md:mb-0 text-white bg-indigo-600 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Get Quote</button>
            </a>
            </div>
          </div>
        </div>
