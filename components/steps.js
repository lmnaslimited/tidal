   ...
   <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          ...
          search ends in four simple steps
        </h2> 
      </div>
      <div className="grid gap-8 row-gap-0 lg:grid-cols-4">
        <div className="relative text-center">
          ...
          <p className="max-w-md mb-3 text-lg text-indigo-600 font-semibold sm:mx-auto">
           Search Product
          </p>
        ...
        <div className="relative text-center">
          ...
          <h6 className="mb-2 text-2xl font-extrabold"> 2</h6>
          <p className="max-w-md mb-3 text-lg text-indigo-600 font-semibold sm:mx-auto">
            Request Quote
          </p>
        ...
        <div className="relative text-center">
          ...
          <h6 className="mb-2 text-2xl font-extrabold"> 4</h6>
          <p className="max-w-md mb-3 text-lg text-indigo-600 font-semibold sm:mx-auto">
          Recieve Consignment
          </p>
