...
export default function nav() {
  return (
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center ">
        ...
        <a href="mailto:sales@tidalgroups.com" ><button className="inline-flex items-center bg-purple-500 text-white hover:bg-indigo-600 border-0 py-1 px-3 focus:outline-none rounded text-base mt-4 md:mt-0">Get Quote
