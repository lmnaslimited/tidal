        ...
        <div className="w-4/5 lg:w-3/4 xl:w-2/4">
          <div className="rounded-lg shadow-lg md:w-auto w-96 flex flex-col md:flex-row  transform transition hover:scale-105 duration-300 ease-in-out">
            <Scope_image width="240" height="240"
              ...
              src= {process.env.assetPrefix + "/scope/Cranes-and-Hatch-Covers-final-238x238.png"}
              alt=""
            />
            <div className="p-3 flex flex-col justify-start">
              ...
              <div className="my-2 px-2">
               <div className="flex flex-row">
                ...
                <Scope_image width="40" height="44" className="h-8  " src= {process.env.assetPrefix + "/Brands/denjet.svg"} alt="" />
                <Scope_image width="52" height="44" className="h-12" src= {process.env.assetPrefix + "/Brands/terasaki.svg"} alt="" />
                <Scope_image width="40" height="44" className="h-8   " src= {process.env.assetPrefix + "/Brands/line.svg"} alt="" />
                <Scope_image width="52" height="44" className="h-12" src= {process.env.assetPrefix + "/Brands/yanmar.svg"} alt="" />
                ...
                />
                <div className="flex flex-row grid  mx-4 gap-2 grid-cols-5 lg:grid-cols-5">
                <Scope_image width="40" height="44" className="h-8   " src= {process.env.assetPrefix + "/Brands/cssc.png"} alt="" />
                <Scope_image width="40" height="44" className="h-8  " src= {process.env.assetPrefix + "/Brands/jx.png"} alt="" />
                ...
                />
                <div className="flex flex-row grid  mx-4 gap-2 grid-cols-5 lg:grid-cols-5">
                <Scope_image width="52" height="44" className="h-12 -mt-2" src= {process.env.assetPrefix + "/Brands/mac.svg"} alt="" />
                </div>
              </div>
                <div className="flex flex-row">
                <Scope_image width="32" height="32"  className="h-8 w-8 rounded-full mt-2 border border-gray-400"
                ...
                />
                <div className="flex flex-row grid  mx-4 gap-2 grid-cols-5 lg:grid-cols-5">
                <Scope_image width="40" height="32" className="h-8  " src= {process.env.assetPrefix + "/Brands/dmc.png"} alt="" />
                <Scope_image width="40" height="32" className="h-8  " src= {process.env.assetPrefix + "/Brands/taekwang1.png"} alt="" />
                  </div>
              </div>
              </div>
