    ...
    return (
        <section id="brands"  className="mx-1 md:mx-10 bg-sky-50 shadow-xl md:my-20 my-10 p-3">
             <div className="flex flex-col text-center w-full mb-20">
                ...
                <p className="lg:w-2/3 text-indigo-500 font-semibold mx-auto text-th-primary-dark leading-relaxed md:text-lg text-base">We assure your orders arrive on time.
                </p>
            </div>
